...
const server = http.createServer((req, res) => {
  ...
  if (req.url === "/") {
    ...
    res.statusCode = 200;
    res.end("<h1>Servicios</h1><p>Ofrecemos una variedad de servicios web.</p>");
    } else if (req.url === "/error") {
    res.statusCode = 500;
    res.end("<h1>Error 500: Error interno del servidor</h1>");
    } else {
    res.statusCode = 404;
    res.end("<h1>Error 404: Página no encontrada</h1><p>Lo sentimos, la página que buscas no existe.</p>");
    }
